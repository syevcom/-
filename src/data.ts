...
export const REVIEWS: Review[] = [
  {
    ...
    blogUrl: 'https://blog.naver.com/help-machine/223587028254',
    isBlogImported: true,
    blogName: '네이버 블로그'
  },
  {
    ...
    afterImg: 'https://images.unsplash.com/photo-1563720223185-11003d516935?auto=format&fit=crop&q=80&w=600',
    author: '나주 고객님',
    interview: '나주 현장 전기차 충전기 설치를 깔끔하고 신속하게 완료해 주셨습니다. 한전 신청부터 완공 검사까지 원스톱으로 처리되어 매우 만족스럽습니다.',
    details: '7kW 완속 스마트 충전기 설치 및 전용 분전함 시공 완료.',
